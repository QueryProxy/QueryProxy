...
class User extends Authenticatable
{
    ...
    /** True when the user holds the DBA role in at least one team. */
    public function isDbaAnywhere(): bool
    {
        return $this->teams()->wherePivot('role', TeamRole::Dba->value)->exists();
    }
